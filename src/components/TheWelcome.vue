...
<template>
  <WelcomeItem>
    ...
    <template #heading>Truite</template>
  ...
  <WelcomeItem>
    ...
    <template #heading>Anguille</template>
  ...
  <WelcomeItem>
    ...
    <template #heading>Requin</template>
  ...
  <WelcomeItem>
    ...
    <template #heading>Cabillaud</template>
  ...
  <WelcomeItem>
    ...
    <template #heading>Espadon</template>
